...
if ($stmt->execute()) {
    audit_log($conn, 'create', 'buyer', $stmt->insert_id, 'Buyer created');
    json_response(['success' => true, 'message' => 'Buyer created']);
}

json_response(['success' => false, 'message' => 'Buyer creation failed'], 500);
