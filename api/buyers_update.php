...
if ($stmt->execute()) {
    audit_log($conn, 'update', 'buyer', $id, 'Buyer updated');
    json_response(['success' => true, 'message' => 'Buyer updated']);
}

json_response(['success' => false, 'message' => 'Buyer update failed'], 500);
